...
export function IconRefresh({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      <path
        d="M20 12a8 8 0 0 0-8-8 8.2 8.2 0 0 0-6.4 3.1"
        stroke="currentColor"
        strokeWidth="2.3"
        strokeLinecap="round"
      />
      ...
      />
      <path
        d="M4 12a8 8 0 0 0 8 8 8.2 8.2 0 0 0 6.4-3.1"
        stroke="currentColor"
        strokeWidth="2.3"
        strokeLinecap="round"
      />
...
export function IconShare({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      ...
      <path
        d="m8.2 13.2 7.6 4.4M15.8 6.4 8.2 10.8"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function IconPhoto({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      ...
      <path
        d="m6.5 16.5 4-4 2.8 2.8 2.2-2.3 4 3.5"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconBackspace({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      <path
        d="M8 6h11.5A1.5 1.5 0 0 1 21 7.5v9a1.5 1.5 0 0 1-1.5 1.5H8l-5-6 5-6Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
...
export function IconAddToHome({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      <rect
        x="6"
...
export function IconIosShare({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      <path
        d="M12 3.5v10.5M12 3.5 8.8 6.7M12 3.5l3.2 3.2"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6.5 10.5v7A1.5 1.5 0 0 0 8 19h8a1.5 1.5 0 0 0 1.5-1.5v-7"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
export function IconSparkle({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      <path
        d="M12 3.5 13.8 9 19.5 10.8 13.8 12.6 12 18.5 10.2 12.6 4.5 10.8 10.2 9 12 3.5Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
